      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl border border-gray-100 p-8 animate-in fade-in zoom-in duration-300">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">
            Log in with your UVA NetBadge username
          </p>
        </div>
        ...
        <form className="space-y-5" action={formAction}>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-3.5 bg-[#232D4B] text-white font-bold rounded-xl shadow-lg hover:bg-[#1a2138] hover:shadow-xl hover:-translate-y-0.5 active:translate-y-0 active:shadow-md transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <p className="text-sm text-center text-gray-500">
            ...
            <Link
              href="/register"
              className="font-medium text-[#232D4B] hover:text-[#E57200] transition"
            >
              Sign Up
            </Link>
          </p>
