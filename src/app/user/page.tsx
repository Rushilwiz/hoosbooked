...
export default async function UserPage() {
  ...
  <div className="w-full max-w-lg my-auto bg-white rounded-2xl shadow-2xl border border-gray-100 p-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="text-center mb-8 lg:col-span-1 space-y-6">
            <div className="w-full max-w-s aspect-square bg-gray-300 rounded-full flex items-center justify-center text-4xl text-[#232D4B] font-bold">
              <h1>{(session.user.username ?? "U").charAt(0)}</h1>
            </div>
          </div>
